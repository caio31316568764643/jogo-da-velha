...
function reniciar () {
    ...
    var quadrado1 = document.getElementById(1);
    quadrado1.style.background = 'rgb(230, 140, 140)';
    quadrado1.style.color = '#red';
    quadrado1.innerHTML = '-';

    var quadrado2 = document.getElementById(2);
    quadrado2.style.background = 'rgb(230, 140, 140)';
    quadrado2.style.color = '#red';
    quadrado2.innerHTML = '-';


    var quadrado3 = document.getElementById(3);
    quadrado3.style.background = 'rgb(230, 140, 140)';
    quadrado3.style.color = '#red';
    quadrado3.innerHTML = '-';

    var quadrado4 = document.getElementById(4);
    quadrado4.style.background = 'rgb(230, 140, 140)';
    quadrado4.style.color = '#red';
    quadrado4.innerHTML = '-';

    var quadrado5 = document.getElementById(5);
    quadrado5.style.background = 'rgb(230, 140, 140)';
    quadrado5.style.color = '#red';
    quadrado5.innerHTML = '-';

    var quadrado6 = document.getElementById(6);
    quadrado6.style.background = 'rgb(230, 140, 140)';
    quadrado6.style.color = '#red';
    quadrado6.innerHTML = '-';

    var quadrado7 = document.getElementById(7);
    quadrado7.style.background = 'rgb(230, 140, 140)';
    quadrado7.style.color = '#red';
    quadrado7.innerHTML = '-';

    var quadrado8 = document.getElementById(8);
    quadrado8.style.background = 'rgb(230, 140, 140)';
    quadrado8.style.color = '#red';
    quadrado8.innerHTML = '-';

    var quadrado9 = document.getElementById(9);
    quadrado9.style.background = 'rgb(230, 140, 140)';
    quadrado9.style.color = '#red';
    quadrado9.innerHTML = '-';
